...
for item_id in top_items:
    ...
    frequency_ratio = frequency_1 / frequency_0  # Replace 0 with NA to avoid division by zero
...
plt.title('Frequency Ratio of Top 10 Items Impression-0 Over Time in Train Set')
plt.xticks(rotation=45)
plt.legend(loc='upper right', bbox_to_anchor=(1.2, 1.05))
plt.tight_layout()

# Save the plot as a PNG file
top_10_items_ratio_plot_path = "top_10_items_Impression_1_0_ratio_nop.png"
