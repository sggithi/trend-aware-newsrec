...
for item_id in top_items:
    ...
    if count== 11:
        break
    item_id_2 = item_id[:-2]
    # Create a Boolean mask to check if each item_id appears in the History
...
plt.title('Frequency of Top 10 Items in Impression-1 Over Time in Train Set')
plt.xticks(rotation=45)
plt.legend(loc='upper right', bbox_to_anchor=(1.2, 1.05))
plt.tight_layout()

# Save the plot as a PNG file
top_100_items_plot_path = "top_10_items_Impression-1_frequency.png"
