...
item_freq_df = pd.read_csv("History_item_frequencies.csv")

# Selecting the top 100 items based on frequency
top_items = item_freq_df.head(10)["ItemID"].tolist()
...
plt.title('Frequency of Top 10 Items in History Over Time in Validation Impression')
plt.xticks(rotation=45)
plt.legend(loc='upper right', bbox_to_anchor=(1.2, 1.05))
plt.tight_layout()

# Save the plot as a PNG file
top_100_items_plot_path = "top_10_History_frequency.png"
